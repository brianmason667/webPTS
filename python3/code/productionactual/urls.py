...
urlpatterns = [
    ...
    path('<uuid:pk>/Downtime', views.EditDowntimeView, name="Downtime"),
    path('<uuid:pk>/Defects', views.EditDefectView, name="Defects"),
    path('<uuid:pk>/RemoveRun', views.RemoveRunView, name="RemoveRun"),
    #path('<uuid:pk>/AddRun', views.AddRunView, name="AddRun"),
    path('<uuid:pk>/AddRun', views.AddRunV2View, name="AddRun"),
